          ...
          >
            <div>
              ...
              <p className="text-gray-600 dark:text-[#A3A3A3] text-xs md:text-sm leading-relaxed">
                ...
                <a
                  href="mailto:laxmanmahto.cse@gmail.com"
                  onClick={(e) => {
                    e.stopPropagation();
                    window.location.href = "mailto:laxmanmahto.cse@gmail.com";
                  }}
          ...
          {/* Visitor Counter */}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <img 
                    src="https://komarev.com/ghpvc/?username=laxman-mahto&label=Visitors Count&color=gray&style=flat-square" 
                    alt="visitor count" 
